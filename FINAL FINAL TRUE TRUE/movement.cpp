...
bool isSpaceEmpty(int direction, double xpos, double ypos, int index, Vertex vertices[]) {
...
void redraw(GLFWwindow* window, GLuint VAO, GLuint VBO, GLuint EBO, GLuint indices[], Vertex vertices[]) { //GOES UNUSED NOT WORKING
...
void resetGame(Vertex vertices[]) { //GOES UNUSED
